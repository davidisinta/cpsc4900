...
class MaterialRegistry
{
    ...
    /// Check existence without emitting a warning.
    bool has(string name)
    {
        return (name in mMaterials) !is null;
    }
    ...
    private void setupSoldierMaterial()
    {
        ...
        mat.AddUniform(new Uniform("uFogEnd", mFogEnd));
        mMaterials["soldier"] = mat;
        // Also allow lookup by texture path (factory.spawn passes type.texturePath as the key)
        mMaterials["./assets/modern_soldier/textures/material_0_baseColor.jpeg"] = mat;
    }
    ...
    private void setupLindenMaterial()
    {
        ...
        mMaterials["linden"] = mat;
        // Also allow lookup by texture path (factory.spawn passes type.texturePath as the key)
        mMaterials["./assets/4-linden-trees-pack-medium-poly/import_1/nature_bark_linden_04_m_0001.jpg"] = mat;
    }
